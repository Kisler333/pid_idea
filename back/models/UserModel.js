...
const userSchema = new mongoose.Schema({
    ...
    topics: {
        //type:Array,
        type:[{"hobby_id":String, "hobby_name":String, "timestamp":Number}],
        //default:[{"hobby_id":0, "hobby_name":"Cooking", "timestamp":Date.now()}],
    required:[true,"must choose at least 1 topics"]
},
